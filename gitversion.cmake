...
if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/../system/gitver.h)
    file(READ ${CMAKE_CURRENT_SOURCE_DIR}/../system/gitver.h VERSION_)
else ()
    set(VERSION_ "")
endif ()

if (NOT "${VERSION}" STREQUAL "${VERSION_}")
    file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/../system/gitver.h "${VERSION}")
endif ()
